...
double Lsm303d::get_acceleration_x()
{
    ...
    double acc_x = double(raw_acc_x) * double(LSM303D_ACC_SCALE) / double(LSM303D_ACC_RESOLUTION);
...
double Lsm303d::get_acceleration_y()
{
    ...
    double acc_y = double(raw_acc_y) * double(LSM303D_ACC_SCALE) / double(LSM303D_ACC_RESOLUTION);
...
double Lsm303d::get_acceleration_z()
{
    ...
    double acc_z = double(raw_acc_z) * double(LSM303D_ACC_SCALE) / double(LSM303D_ACC_RESOLUTION);
...
double Lsm303d::get_magnetic_field_x()
{
    ...
    double mag_x = double(raw_mag_x) * double(LSM303D_MAG_SCALE) / double(LSM303D_MAG_RESOLUTION);
...
double Lsm303d::get_magnetic_field_y()
{
    ...
    double mag_y = double(raw_mag_y) * double(LSM303D_MAG_SCALE) / double(LSM303D_MAG_RESOLUTION);
...
double Lsm303d::get_magnetic_field_z()
{
    ...
    double mag_z = double(raw_mag_z) * double(LSM303D_MAG_SCALE) / double(LSM303D_MAG_RESOLUTION);
