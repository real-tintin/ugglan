#ifndef DATA_LOG_SIGNALS_HPP
#define DATA_LOG_SIGNALS_HPP
...
inline const DataLogGroupMap DATA_LOG_GROUP_MAP = {
    {DataLogGroup::Imu, {"IMU"}}, {DataLogGroup::Esc, {"ESC"}}, {DataLogGroup::Type, {"TYPE"}}};
...
#else
inline const DataLogGroupMap DATA_LOG_GROUP_MAP = {{DataLogGroup::Imu, {"Imu"}},
