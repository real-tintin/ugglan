...
inline const std::map<uint16_t, SwitchLr> SwitchLrMap = {{TGYIA6C_RAW_SWITCH_LR_LOW, SwitchLr::Low},
                                                         {TGYIA6C_RAW_SWITCH_LR_MIDDLE, SwitchLr::Middle},
                                                         {TGYIA6C_RAW_SWITCH_LR_HIGH, SwitchLr::High}};

inline const std::map<uint16_t, SwitchM> SwitchMMap = {{TGYIA6C_RAW_SWITCH_M_LOW, SwitchM::Low},
...
inline const ControlFlags TGYIA6C_SERIAL_OPT = {.c_cflag = (B115200 | CS8 | CLOCAL | CREAD), // 115200 bps
                                                .c_iflag = IGNPAR,
                                                .c_oflag = 0,
                                                .c_lflag = 0};
