#ifndef ZMQ_CONN_STUB_H
#define ZMQ_CONN_STUB_H
    ...
    public:                                                                                         \
        ...
        {                                                                                           \
            _exp_recv_msg.rebuild(msg.data(), msg.size());                                          \
                                                                                                    ...
                                                                                                    \
        const uint32_t get_n_calls_recv() { return _n_calls_recv; }                                 \
        const uint32_t get_n_calls_send() { return _n_calls_send; }                                 \
                                                                                                    \
        const zmq::message_t& get_last_send_msg() { return _last_send_msg; }                        \
                                                                                                    \
        void clear_last_send_msg() { return _last_send_msg.rebuild(); }                             \
    private:                                                                                        \
