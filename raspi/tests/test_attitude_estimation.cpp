...
static const att_est::Config CONFIG_ZERO_SENSOR_ERROR = {.n_samples_gyro_bias_compensation = 10,
...
static const uint32_t EXEC_UNTIL_CALIB =
    CONFIG_ZERO_SENSOR_ERROR.n_samples_gyro_bias_compensation + CONFIG_ZERO_SENSOR_ERROR.rolling_var_window_size;
...
{
    for (uint32_t i_sample = 0; i_sample < n_samples; i_sample++)
    {
...
TEST_CASE("static error compensation")
{
    WHEN("an estimator is created with a non zero static sensor error config")
    {
        ...
        {
            att_est::Imu imu_uncompensated = {.acc_x = (1.0 - config_non_zero_sensor_error.acc_error_b_x) /
                                                       config_non_zero_sensor_error.acc_error_s_x,
                                              .acc_y = (1.0 - config_non_zero_sensor_error.acc_error_b_y) /
                                                       config_non_zero_sensor_error.acc_error_s_y,
                                              .acc_z = (1.0 - config_non_zero_sensor_error.acc_error_b_z) /
                                                       config_non_zero_sensor_error.acc_error_s_z,
