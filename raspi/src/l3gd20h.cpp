...
double L3gd20h::get_angular_rate_x()
{
    ...
    int16_t raw_ang_rate_x = static_cast<int16_t>((buf[L3GD20H_BUF_OUT_X_H] << 8) | buf[L3GD20H_BUF_OUT_X_L]);
...
double L3gd20h::get_angular_rate_y()
{
    ...
    int16_t raw_ang_rate_y = static_cast<int16_t>((buf[L3GD20H_BUF_OUT_Y_H] << 8) | buf[L3GD20H_BUF_OUT_Y_L]);
...
double L3gd20h::get_angular_rate_z()
{
    ...
    int16_t raw_ang_rate_z = static_cast<int16_t>((buf[L3GD20H_BUF_OUT_Z_H] << 8) | buf[L3GD20H_BUF_OUT_Z_L]);
