...
double L3gd20h::get_angular_rate_x()
{
    ...
    double ang_rate_x = double(raw_ang_rate_x) * L3GD20H_GYRO_SCALE / L3GD20H_GYRO_RESOLUTION;
...
double L3gd20h::get_angular_rate_y()
{
    ...
    double ang_rate_y = double(raw_ang_rate_y) * L3GD20H_GYRO_SCALE / L3GD20H_GYRO_RESOLUTION;
...
double L3gd20h::get_angular_rate_z()
{
    ...
    double ang_rate_z = double(raw_ang_rate_z) * L3GD20H_GYRO_SCALE / L3GD20H_GYRO_RESOLUTION;
