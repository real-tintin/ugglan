...
TITLE_STR = r'Hard iron bias: $V_x$ = {:.3f}, $V_y$ = {:.3f}, $V_z$ = {:.3f}'


def _hard_iron_bias(data):
    """ Get signals """
    ...
    """ Estimate bias using MLSE (Bp-V)'*(Bp-V) = B^2 """
...
def main():
    parser = argparse.ArgumentParser(description='Hard iron bias estimation of data log file.')
