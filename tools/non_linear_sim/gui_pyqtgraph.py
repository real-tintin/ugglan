...
# TODO: Refactor the init logic. Then generalize and configure the plots.
# TODO: to select plot in window with breakout?
...
class ConfigStepResponse:
    t_end_s: float = 10.0
    ref_input: RefInput = RefInput(f_z=-12.0, roll=0.0, pitch=0.0, yaw_rate=0.0)
...
class SixDofWidget(SubplotWidget):
    def __init__(self, data_cb: Callable):
        ...
        # TODO: Should be a 3d-object. Flip z-axis.
...
class AttRefWidget(SubplotWidget):
    def __init__(self, data_cb: Callable, y_label: str, y_unit: str):
        ...
        self._plot_att_act = pg.PlotDataItem()
        self._plot_att_est = pg.PlotDataItem()
        self._plot_att_ref = pg.PlotDataItem()
